...
export default function Rail({ activeNav, onNav, onTweaks }: RailProps) {
  return (
    <aside className="rail">
      ...
      <button className={`rail-btn${activeNav === 'home' ? ' active' : ''}`} onClick={() => onNav('home')}>
        <HomeIcon />
        <span className="lbl">Home</span>
      </button>
      <button className={`rail-btn${activeNav === 'pages' ? ' active' : ''}`} onClick={() => onNav('pages')}>
        <PagesIcon />
        <span className="lbl">Pages</span>
      </button>
      <button className={`rail-btn${activeNav === 'agents' ? ' active' : ''}`} onClick={() => onNav('agents')}>
        <AgentsIcon />
        <span className="lbl">Agents</span>
      </button>
      <button className={`rail-btn${activeNav === 'starred' ? ' active' : ''}`} onClick={() => onNav('starred')}>
        <StarIcon />
        <span className="lbl">Starred</span>
      </button>
      <button className={`rail-btn${activeNav === 'notif' ? ' active' : ''}`} onClick={() => onNav('notif')}>
        <BellIcon />
      ...
      <button className="rail-btn" onClick={onTweaks}>
        <SettingsIcon />
      ...
      <div className="rail-avatar">SS</div>
    </aside>
  );
}
